            ...
            <div class="admin-card p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex gap-4 items-center p-3 bg-white/5 rounded-lg">
                        <img src="../<?= $item['imagem']?>" class="w-16 h-16 object-cover rounded bg-admin-gray-800">
                        <div class="flex-1">
            ...
            <div class="admin-card p-6">
                ...
                <form method="POST" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="transportadora"
                                ...
                                placeholder="Ex: Correios" class="w-full">
                        </div>
                        <div>
                            <label
                            ...
                            <input type="text" name="codigo_rastreio"
                                ...
                                placeholder="Ex: AB123456789BR" class="w-full uppercase">
                        </div>
                    </div>
                    ...
                    <button type="submit" name="atualizar_rastreio"
                        class="btn btn-primary bg-white text-black hover:bg-gray-200">
            ...
            <div class="admin-card p-6">
                ...
                <form method="POST" class="space-y-3">
                    ...
                    <button type="submit" name="mudar_status"
                        class="w-full btn border border-white/20 text-white hover:bg-white/10">
                        Atualizar Status
                    </button>
                </form>
            </div>
