    ...
    <div id="sidebar" class="admin-sidebar fixed left-0 top-0 h-full w-64 z-50 lg:translate-x-0 mobile-menu">
        <div class="p-6">
            ...
            <nav class="space-y-2">
                ...
                <a href="gerenciar_sumup.php" class="admin-nav-item flex items-center gap-3 px-4 py-3 rounded-lg text-admin-gray-300 hover:text-white <?= basename($_SERVER['PHP_SELF']) == 'gerenciar_sumup.php' ? 'active' : '' ?>">
                    <i class="fas fa-credit-card w-5"></i>
                    <span>Gerenciar SumUp</span>
                </a>
