<?php
// admin/gerenciar_tamanhos.php — Gerenciamento de Grupos de Tamanho
...
try {
    ...
    $grupos = [];
    // Tabela não existe — redireciona para setup
...
<div class="space-y-8">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            ...
            <p class="text-admin-gray-400">Gerencie os tamanhos predefinidos para produtos físicos</p>
        </div>
    </div>
        ...
        <div class="flex items-start gap-3">
            ...
            <div>
                <p class="text-sm text-white/80 leading-relaxed">
                    Crie grupos de tamanho (ex: "Tênis", "Roupas") com os tamanhos predefinidos.
                    Depois, ao adicionar ou editar um produto físico, basta selecionar o grupo e os tamanhos
                    disponíveis.
                </p>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <form action="processa_tamanho.php" method="POST">
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="nome_grupo" required placeholder="Ex: Tênis, Roupas..."
                                    class="w-full">
                            </div>
                            <div>
                                <label
                                ...
                                <input type="text" name="descricao_grupo" placeholder="Ex: Numeração para calçados"
                                    class="w-full">
                            </div>
                            <div>
                                <label
                                    class="block text-xs font-semibold text-admin-gray-400 uppercase tracking-wider mb-2">
                                    Tamanhos <span class="text-white/40">(separados por vírgula)</span>
                                </label>
                                <input type="text" name="tamanhos" required placeholder="Ex: 36,37,38,39,40,41,42"
                                    class="w-full">
                                <p class="text-xs text-admin-gray-500 mt-1">Separe os tamanhos por vírgula. Ex:
        ...
        <div class="lg:col-span-2">
            ...
            <div class="admin-card rounded-xl p-12 text-center">
                ...
                <p class="text-admin-gray-500 text-sm">Crie seu primeiro grupo usando o formulário ao lado.</p>
            </div>
            <?php
else: ?>
            <div class="space-y-4">
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-2">
                            <a href="processa_tamanho.php?deletar_grupo=<?= $grupo['id']?>"
                                onclick="return confirm('Excluir o grupo e todos os tamanhos? Produtos com esse grupo perderão a configuração de tamanhos.')"
