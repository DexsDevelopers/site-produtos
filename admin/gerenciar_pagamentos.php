...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'pix') {
        ...
        if (empty($chave_pix)) $erros_pix[] = 'A chave PIX é obrigatória.';
        if (empty($nome_pix)) $erros_pix[] = 'O nome do recebedor é obrigatório.';
        if (empty($cidade_pix)) $erros_pix[] = 'A cidade é obrigatória.';
        ...
        $erros_infinite = [];
        if (empty($infinite_tag)) $erros_infinite[] = 'A InfiniteTag é obrigatória.';
...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <!-- InfinitePay -->
        <div class="admin-card rounded-xl p-6 border-t-4 border-infinitepay" style="border-top-color: #00ff00;">
            <div class="flex items-center gap-4 mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-admin-gray-400">Checkout Integrado (Cartão e PIX)</p>
                </div>
            </div>
            ...
            <form method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <p class="mt-2 text-xs text-admin-gray-400">
                        Sua InfiniteTag é o nome de usuário que você usa no App da InfinitePay.
                    </p>
                </div>
            ...
            <div class="mt-6 p-4 bg-admin-gray-800/50 rounded-lg">
                ...
                <ul class="text-xs text-admin-gray-400 space-y-1">
                    <li>• O cliente é redirecionado para a página da InfinitePay.</li>
        ...
        <!-- PIX Manual -->
        <div class="admin-card rounded-xl p-6 border-t-4 border-admin-primary">
            <div class="flex items-center gap-4 mb-6">
