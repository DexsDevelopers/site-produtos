...
<head>
    ...
    <style>
        ...
        .gradient-title { background: linear-gradient(90deg, #ffffff, #a0aec0); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
    </style>
</head>
<body>
    <!-- Header Simples -->
        ...
        <div class="mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-gray-800 rounded-lg overflow-hidden">
                    <img src="<?= htmlspecialchars($banner['imagem']) ?>" alt="<?= htmlspecialchars($banner['titulo']) ?>" class="w-full h-48 object-cover">
                    <div class="p-4">
            ...
            <div class="flex gap-4 overflow-x-auto">
                ...
                <a href="<?= htmlspecialchars($banner['link']) ?>" class="flex-shrink-0 text-center">
                    <div class="w-20 h-20 bg-gray-800 rounded-full mb-2 flex items-center justify-center">
                        <img src="<?= htmlspecialchars($banner['imagem']) ?>" alt="<?= htmlspecialchars($banner['titulo']) ?>" class="w-16 h-16 object-cover rounded-full">
                    </div>
        ...
        <?php foreach ($categorias as $categoria): ?>
            ...
            <div class="mb-12">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                    ...
                    <a href="produto.php?id=<?= $produto['id'] ?>" class="bg-gray-800 rounded-lg overflow-hidden hover:bg-gray-700 transition-colors">
                        <img src="<?= htmlspecialchars($produto['imagem']) ?>" alt="<?= htmlspecialchars($produto['nome']) ?>" class="w-full h-32 object-cover">
                        <div class="p-3">
