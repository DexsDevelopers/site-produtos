    ...
    <div class="performance-dashboard">
        ...
        <div class="test-section">
            ...
            <div class="metric">
                ...
                <span class="metric-value <?= $execution_time < 0.5 ? 'status-good' : ($execution_time < 1 ? 'status-warning' : 'status-error') ?>">
            ...
            <div class="metric">
                ...
                <span class="metric-value <?= $memory_used < 1024*1024 ? 'status-good' : ($memory_used < 5*1024*1024 ? 'status-warning' : 'status-error') ?>">
            ...
            <div class="metric">
                ...
                <span class="metric-value <?= $peak_memory < 5*1024*1024 ? 'status-good' : ($peak_memory < 10*1024*1024 ? 'status-warning' : 'status-error') ?>">
            ...
            <div class="metric">
                ...
                <span class="metric-value <?= $db_time < 0.1 ? 'status-good' : ($db_time < 0.3 ? 'status-warning' : 'status-error') ?>">
                    <?= round($db_time, 4) ?>s
                </span>
            </div>
            ...
            <div class="metric">
                ...
                <span class="metric-value <?= $cache_time < 0.01 ? 'status-good' : ($cache_time < 0.05 ? 'status-warning' : 'status-error') ?>">
            ...
            <div class="metric">
                ...
                <span class="metric-value <?= $image_time < 0.1 ? 'status-good' : ($image_time < 0.5 ? 'status-warning' : 'status-error') ?>">
