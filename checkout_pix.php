...
if (!empty($carrinho_itens)) {
    try {
        ...
        if ($user_id > 0) {
            ...
            $stmt->execute([$user_id, $total_preco]);
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                <div class="lg:col-span-1">
                    <div class="pix-card sticky top-24"
                        style="z-index: 10; max-height: calc(100vh - 120px); overflow-y: auto;">
                        ...
                        <div class="space-y-4 mb-6">
                            ...
                            <div class="flex justify-between items-start py-3 border-b border-white/5">
                                <div class="flex-1">
                                    ...
                                    <p class="text-white/50 text-[10px] uppercase font-bold tracking-wider mt-0.5">
                                        Tamanho:
                                ...
                                <p class="text-white font-semibold ml-4">R$
    ...
    endforeach; ?>
                        ...
                        <div class="pt-4 border-t border-white/10 total-container">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span class="price-highlight text-2xl">R$
                    ...
                    <div class="pix-card">
                        ...
                        <div class="mt-4 p-3 bg-white/5 rounded-lg border border-white/10">
                            <p class="text-white/70 text-sm">
                                <strong class="text-white">Beneficiário:</strong>
                                <?= htmlspecialchars($nome_pix)?>
                            </p>
                            <?php if (!empty($cidade_pix)): ?>
                            <p class="text-white/70 text-sm mt-1">
                                <strong class="text-white">Cidade:</strong>
                                <?= htmlspecialchars($cidade_pix)?>
                            </p>
                            <?php
        endif; ?>
                        </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                ...
                <a href="index.php"
                    class="copy-button text-center bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800">
